...
import '3game3field.dart';

class Game3Unit3 extends StatefulWidget {
  final Game3Unit3Brain fieldsBrain = Game3Unit3Brain();
  @override
  _Game3Unit3State createState() => _Game3Unit3State();
}

class _Game3Unit3State extends State<Game3Unit3> {
