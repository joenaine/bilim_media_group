...
import '5game1field.dart';

class Game1Unit5 extends StatefulWidget {
  final Game1Unit5Brain fieldsBrain = Game1Unit5Brain();
  @override
  _Game1Unit5State createState() => _Game1Unit5State();
}

class _Game1Unit5State extends State<Game1Unit5> {
        ...
        children: <Widget>[
          Expanded(
            child: Padding(
              ...
              child: Center(
                child: Image.asset(widget.fieldsBrain.getFieldsPicture()),
              ),
            ),
          ),
