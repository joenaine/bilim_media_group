...
import '4game3field.dart';

class Game3Unit4 extends StatefulWidget {
  final Game3Unit4Brain fieldsBrain = Game3Unit4Brain();
  @override
  _Game3Unit4State createState() => _Game3Unit4State();
}

class _Game3Unit4State extends State<Game3Unit4> {
          ...
          Expanded(
            child: Padding(
              ...
              child: Center(
                child: Column(
                  children: [
                    Image.asset('assets/pictures/Aiganym.PNG'),
                    Text(
