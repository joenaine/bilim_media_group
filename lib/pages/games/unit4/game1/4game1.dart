...
import '4game1fields.dart';

class Game1Unit4 extends StatefulWidget {
  final Game1Unit4Brain fieldsBrain = Game1Unit4Brain();
  @override
  _Game1Unit4State createState() => _Game1Unit4State();
}

class _Game1Unit4State extends State<Game1Unit4> {
          ...
          Expanded(
            child: Padding(
              ...
              child: Center(
                child: Column(
                  children: [
                    Image.asset(widget.fieldsBrain.getFieldsPicture()),
                    Text(
